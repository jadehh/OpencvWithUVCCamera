...
public class UVCCameraHelper {
    ...
    public interface OnMyDevConnectListener {
        void onAttachDev(UsbDevice device,final int cameraId);
    ...
    public void initUSBMonitor(Activity activity, CameraViewInterface cameraView, final OnMyDevConnectListener listener,final int cameraId) {
        ...
        mUSBMonitor = new USBMonitor(activity.getApplicationContext(), new USBMonitor.OnDeviceConnectListener() {
            ...
            public void onAttach(UsbDevice device) {
                if (listener != null) {
                    listener.onAttachDev(device, cameraId);
                }
            }
    ...
    public void setExposureMode(int mode){
        if (mCameraHandler != null) {
            mCameraHandler.setCameraExposureMode(mode);
        }
    }

    public void setExposureValue(int value){
        if (mCameraHandler != null) {
            mCameraHandler.setCameraExposureValue(value);
        }
    }
    public void changeWeight(){
        if (mCameraHandler !=null){
            mCameraHandler.changeWeight();
        }
    }
    public void changeWeightValue(double[] weight){
        if (mCameraHandler != null){
            mCameraHandler.changeWeightValue(weight);
        }
    }
    public void initMotionParms(int[] parmas){
        if (mCameraHandler != null){
            mCameraHandler.initMtionParameter(parmas);
        }
