...
public class USBSize implements Parcelable {
	//
	/**
	 ...
	 * @param _height
	 */
	public USBSize(final int _type, final int _frame_type, final int _index, final int _width, final int _height) {
		type = _type;
	 ...
	 */
	public USBSize(final int _type, final int _frame_type, final int _index, final int _width, final int _height, final int _min_intervals, final int _max_intervals, final int _step) {
		type = _type;
		frame_type = _frame_type;
		index = _index;
		width = _width;
     ...
     * @param _intervals
     */
	public USBSize(final int _type, final int _frame_type, final int _index, final int _width, final int _height, final int[] _intervals) {
		type = _type;
		frame_type = _frame_type;
		index = _index;
		width = _width;
	 ...
	 * @param other
	 */
	public USBSize(final USBSize other) {
		type = other.type;
	...
	private USBSize(final Parcel source) {
	...
	public USBSize set(final USBSize other) {
		if (other != null) {
			type = other.type;
			frame_type = other.frame_type;
			index = other.index;
	...
	public static final Creator<USBSize> CREATOR = new Creator<USBSize>() {
		@Override
		public USBSize createFromParcel(final Parcel source) {
			return new USBSize(source);
		}
		@Override
		public USBSize[] newArray(final int size) {
			return new USBSize[size];
		}
	};
}
